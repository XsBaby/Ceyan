...
import com.xushuai.ceyan.dao.ChannelDao;
import com.xushuai.ceyan.db.SQLHelper;
...
public class ChannelManage {
	...
	static {
		...
		defaultOtherChannels.add(new ChannelItem(8, "军事", 8, 1));
		defaultOtherChannels.add(new ChannelItem(9, "趣图", 9, 1));
		defaultOtherChannels.add(new ChannelItem(10, "段子", 10, 1));
		defaultOtherChannels.add(new ChannelItem(11, "财经", 1, 0));
		defaultOtherChannels.add(new ChannelItem(12, "汽车", 2, 0));
		defaultOtherChannels.add(new ChannelItem(13, "房产", 3, 0));
		defaultOtherChannels.add(new ChannelItem(14, "社会", 4, 0));
		defaultOtherChannels.add(new ChannelItem(15, "情感", 5, 0));
		...
		defaultOtherChannels.add(new ChannelItem(19, "美女", 9, 0));
		defaultOtherChannels.add(new ChannelItem(20, "游戏", 10, 0));
	}
